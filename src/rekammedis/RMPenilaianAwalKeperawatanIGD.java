...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-03-2026 16:38:09" }));
    ...
    private void BtnSoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSoapActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            try {
                ps = koneksi.prepareStatement(
                    "SELECT p.rps, p.rpk, p.rpd, p.rpo, p.alergi " +
                    "FROM penilaian_medis_ranap p " +
                    "WHERE p.no_rawat = ? " +
                    "ORDER BY p.tanggal ASC LIMIT 1"
                );
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Data Awal Medis tidak ditemukan untuk pasien ini");
                }
            } catch (Exception e) {
