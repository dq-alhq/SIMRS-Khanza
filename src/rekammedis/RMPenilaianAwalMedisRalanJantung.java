...
public final class RMPenilaianAwalMedisRalanJantung extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2026 19:34:08" }));
               ...
               ps = koneksi.prepareStatement(
                ...
                if (rs.next()) {
                  // Map SOAPIE data to form fields
                    ...
                    Tindakan.setText(rs.getString("rtl"));
                    Terapi.setText(rs.getString("instruksi"));
                    Permasalahan.setText(rs.getString("evaluasi"));
