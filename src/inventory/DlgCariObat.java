...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private double h_belicari = 0, hargacari = 0, sisacari = 0, y = 0,
    ...
    private void initComponents() {
        ...
        TNamaTemplate.setBounds(170, 100, 510, 24);
        ...
        ChkSimpanTemplate.setBounds(40, 100, 130, 17);
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    ...
                    if (sukses == true) {
                        ...
                        if (ttljual > 0) {
                            if (Sequel.menyimpantf2("tampjurnal", "'" + Suspen_Piutang_Obat_Ralan
                                    + "','Suspen Piutang Obat Ralan','" + ttljual + "','0'", "Rekening") == false) {
                                sukses = false;
                            }
                        ...
                        if (ttlhpp > 0) {
                            if (Sequel
                                    .menyimpantf2(
                                            "tampjurnal", "'" + HPP_Obat_Rawat_Jalan
                                                    + "','HPP Persediaan Obat Rawat Jalan','" + ttlhpp + "','0'",
                                            "Rekening") == false) {
                                sukses = false;
                            }
                            if (Sequel.menyimpantf2(
                                    "tampjurnal", "'" + Persediaan_Obat_Rawat_Jalan
                    ...
                    if (TCari.getText().trim().equals("")) {
                        ...
                        for (JsonNode list : response) {
                            if (list.path("KodeBarang").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                                    ...
                                    || list.path("Kandungan").asText().toLowerCase()
                                            .contains(TCari.getText().toLowerCase())
                                    || list.path("NoBatch").asText().toLowerCase()
                                            .contains(TCari.getText().toLowerCase())) {
                                tabModeobat.addRow(new Object[] {
                                        false, "", list.path("KodeBarang").asText(), list.path("NamaBarang").asText(),
                                        list.path("Satuan").asText(), list.path("Kandungan").asText(),
